...
export type SaleRecord = {
  ...
  items: { medicineId: string; medicineName: string; quantity: number; unitPrice: number; subtotal: number }[];
};
...
export const canAccess = (role: UserRole, area: AccessArea) => ROLE_ACCESS[role]?.includes(area) ?? false;
